...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, n_actions, gamma=0.99,
                 max_size=1000000, fc1_dims=400, fc2_dims=300, fc3_dims =100,
                 batch_size=64):
        self.gamma = gamma
        self.tau = tau
        ...
        self.critic = CriticNetwork(beta, input_dims, fc1_dims, fc2_dims, fc3_dims,
                                n_actions=n_actions, name='critic')

        self.target_actor = ActorNetwork(alpha, input_dims, fc1_dims, fc2_dims, fc3_dims,
                                n_actions=n_actions, name='target_actor')

        self.target_critic = CriticNetwork(beta, input_dims, fc1_dims, fc2_dims, fc3_dims,
